...
/**
 * The five stages of finishing a basement.
 *
 ...
 * of priority.
 *
 * Note for the client: all five step images are PNGs of photographs at
 * 1.2-1.6 MB each. next/image re-encodes them for delivery, so visitors are
 * fine, but they are heavy to store and slow to optimise; JPEG or WebP
 * originals would be better.
 */
export function BasementProcess({ process }) {
