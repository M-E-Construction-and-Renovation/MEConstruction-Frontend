...
export function ShowerInspiration() {
  const inspirationCards = [
    {
      icon: ImageIcon,
      title: "Photo Gallery",
      description:
        "View hundreds of beautiful shower styles and designs to inspire your project.",
      cta: "Explore Gallery",
    ...
    {
      icon: Pencil,
      title: "Design Your Shower",
      description:
        "Use our interactive design tool to customize and visualize your perfect shower.",
      cta: "Start Designing",
  ...
  return (
    <section className="py-16 md:py-24 bg-gradient-to-br from-accent/5 via-primary/10 to-accent/5">
      <div className="container mx-auto px-4 max-w-6xl">
        <div className="text-center mb-12 md:mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Explore our gallery and design tool to find your perfect shower
            solution
          </p>
        </div>
