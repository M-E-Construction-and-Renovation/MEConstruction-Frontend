...
import { ArrowRight, Droplets, LogIn, Accessibility } from "lucide-react";
  ...
  const showerTypes = [
    {
      ...
      title: "Modern Shower",
      description:
        "A fresh, clean shower designed to meet your needs with premium finishes and modern aesthetics.",
      cta: "Explore Showers",
    ...
    },
    {
      ...
      description:
        "Convert your existing bathtub into an extra-large shower for maximum space and luxury.",
      cta: "Learn More",
    ...
    },
    {
      ...
      description:
        "Low-threshold, walk-in design provides safe, convenient entry perfect for all ages.",
      cta: "Discover More",
      ...
      <div className="container mx-auto px-4 max-w-6xl">
        <div className="text-center mb-12 md:mb-16 animate-in fade-in duration-700">
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
            Shower Solutions For Every Need
          </h2>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Whether you're looking for a refresh, a conversion, or accessibility
            improvements, we have the perfect solution for you.
          </p>
        </div>
            ...
            >
              <div className="flex flex-col h-full">
                ...
                <div className="p-6 space-y-4 flex flex-col flex-grow">
                  ...
                  <Button
                    variant="ghost"
                    //   className="w-full text-primary self-end"
