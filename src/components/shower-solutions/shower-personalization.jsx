...
export function ShowerPersonalization() {
  const features = [
    {
      icon: Palette,
      title: "Sleek Upgrade",
      description:
        "Choose from thousands of combinations of wall styles, faucets, and accessories.",
    },
    {
      icon: Wrench,
      title: "Improved Safety",
      description:
        "Low-threshold and accessible designs perfect for all ages and mobility needs.",
    },
    {
      icon: Zap,
      title: "Tailored to Your Space",
      description:
        "Custom-fit solutions designed specifically for your bathroom dimensions and style.",
    },
  ];

  return (
    <section className="py-16 md:py-24 bg-gradient-to-r from-primary/80 via-primary/100 to-primary/80 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10 max-w-6xl">
        <div className="text-center mb-12 md:mb-16">
          ...
          <p className="text-lg text-white max-w-2xl mx-auto">
            With thousands of options and accessories, there are endless
            combinations to help customize your shower and fit your style.
          </p>
        </div>
