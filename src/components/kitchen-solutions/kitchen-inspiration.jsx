 ...
 *
 * Both CTAs pointed into a /kitchen-inspiration/* section that does not exist —
 * /gallery and /before-after under that prefix each returned 404, in both
 * locales. Repointed in the content to the real /gallery and /before-after
 * routes, which is what the card copy promises anyway.
 *
 * The photographs were declared width 400 by height 300 over sources that are
 * 1364x836 and 1030x509, then stretched to fill an h-64 box, so next/image
 * built a srcset for a 400px box and the browser scaled up whatever arrived.
 * Real frames with sizes hints now, lazy rather than priority.
 *
