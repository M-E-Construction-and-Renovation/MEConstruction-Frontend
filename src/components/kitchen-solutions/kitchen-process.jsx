...
/**
 * The five stages of a kitchen renovation.
 *
 ...
 * 2.2.2) — the only thing that halted it was clicking a step, and nothing told
 * a visitor that. It also hid four of the five stages at any moment, which is
 * the wrong trade for content whose entire point is that it is a sequence.
 *
 ...
 * "h-80 md:h-full aspect-[4/3]" — three competing sizes on one element. Square
 * frames with a sizes hint now, lazy instead of priority.
 *
 * Note for the client: step 4 ("Installation") uses kitchen-solutions-before,
 * the before photograph from the transformation above it, to illustrate the
 * work being done.
 */
export function KitchenProcess({ process }) {
