...
/**
 * The three kitchen jobs this firm takes on.
 *
 * All three CTAs pointed into a /kitchen-inspiration/* section that does not
 * exist in the app — /modern, /layouts and /family-friendly each returned 404,
 * in both locales. Repointed in the content to the routes their own copy
 * promises: "Explore Designs" and "Discover More" to /gallery, "See Before and
 * After" to /before-after.
 *
 ...
 */
const ICONS = { Coffee, Layout, Users };

export function KitchenTypes({ types }) {
