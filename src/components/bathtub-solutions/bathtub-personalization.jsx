...
import { ArrowRight, HelpCircle, Palette, Settings, Zap } from "lucide-react";
 ...
 * blob and a 40x40 primary blob at 10% opacity under blur-3xl — two extra
 * composited layers producing a smudge nobody can identify. Gone.
 *
...
export function BathtubPersonalization({ personalization }) {
