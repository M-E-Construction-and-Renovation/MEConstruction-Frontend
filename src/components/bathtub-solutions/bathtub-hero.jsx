 ...
 * Page hero.
 *
 * A content bug first, shared with the shower page because the two components
 * were byte-identical: the second highlight rendered
 * highlights.highlight1.description, so "Premium Quality" was captioned
 * "Stress-Free Process" and its own "Long-Lasting Comfort" never appeared on
 * the page, in either locale. Fixed.
 *
 * This one does go full-bleed, unlike the shower hero: the source is
 * 5977x3985, so it carries a full-width frame at any viewport without
 * upscaling. The shower page has only a 1024px image and stays framed.
 *
        ...
        <div className="max-w-3xl">
          ...
          <Reveal delay={200} className="mt-9 flex flex-col gap-3 sm:flex-row">
            <Button
              variant="cta"
              size="xl"
              onClick={() => dispatch(openModal("bathtub_hero"))}
