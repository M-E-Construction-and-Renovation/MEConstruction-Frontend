...
export function Gallery({ gallery }) {
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute inset-0 // Position absolutely to cover the entire section
                   bg-[url('/images/home-inspiration-bg.jpg')] bg-cover bg-center bg-no-repeat
                   filter blur-sm // APPLY STANDARD BLUR FILTER
                   z-0 // Set this background element to the lowest z-index
                   scale-105 // Optional: Slightly scale the image to hide blurred edges from filter
        "
