export const wallsCategories = [
  {
    ...
    products: [
      ...
      },
      {
        ...
        roughnessMap:
          "/textures/walls/wall_tile_1/Tiles075_2K-JPG_Roughness.jpg",
        displayByColor: {
          Black: {
            productDisplay:
